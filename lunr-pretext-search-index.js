...
},
{
  ...
  "number": "2.6.2",
  "title": "",
  "body": "  The vector is a solution to if and only if it is a solution to .    Suppose that is a solution to . Then we have . We know that is orthogonal to . states that the kernel of is the orthogonal complement of in . Since is in the orthogonal complement of , we conclude that . But this means that . So, .  We now prove the converse. Suppose that is a solution to . Rewriting the equation, we get . In other words, is in the kernel of . Since the kernel of is , this means that is a vector in . Again, writing , and using the fact that , we conclude that is in . However, and are two vectors in , and so . Therefore, .   "
},
{
