...
{
  "id": "exercises-chapter2-section2-10",
  "level": "2",
  "url": "sec-linear-dependence.html#exercises-chapter2-section2-10",
  "type": "Exercise",
  "number": "2.3.10",
  "title": "",
...
},
{
  ...
  "number": "2.4.2",
  "title": "",
  "body": " Consider the set . This set is a line in the plane containing the origin (the line ), and it is an example of a vector subspace of . Indeed, if , then , and it is clear that the -coordinate of is three times its -coordinate, which means that for every . Similarly, if and are both in , then we must have and . This leads to . The two axioms of a vector subspace are satisfied, which means that is a vector subspace of .  "
},
{
...
},
{
  ...
  "number": "2.4.17",
  "title": "",
  "body": "  If is a linear subspace of , then there is a finite linearly independent set of vectors in such that .    This is a direct consequence of Proposition . Indeed, the set itself spans . Using Proposition , we immediately conclude that there is a finite subset of that spans and that is linearly independent.   "
},
{
  "id": "def-basis",
  "level": "2",
