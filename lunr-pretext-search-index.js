...
},
{
  ...
  "number": "2.3.11",
  "title": "",
  "body": "  Let be an matrix.   Show that if one of the columns of is , then .    ★ Show that if the columns of form a linear dependent set of vectors, then .       Use the fact that the determinant is linear on the columns of a matrix.   "
},
{
...
},
{
  ...
  "number": "2.4.1",
  "title": "",
  "body": "  A subset of is called a linear subspace of if the following conditions hold:   If , then (i.e., is closed under addition).    If and , then (i.e., is closed under scalar multiplication).      "
},
{
...
{
  "id": "sec-linear-subspaces-29",
  "level": "2",
  "url": "sec-linear-subspaces.html#sec-linear-subspaces-29",
  "type": "Example",
  "number": "2.4.22",
  "title": "",
  "body": " Let be the linear subspace of consisting of vectors in satisfying the equations and . Solving the system, we see that and are free variables and the solutions to the system can be given in parametric form as , where . Setting and , we find the solution . If we now set and , we get . Since these two vectors are linearly independent and , they constitute a basis of .  "
},
{
...
{
  "id": "sec-linear-subspaces-35",
  "level": "2",
  "url": "sec-linear-subspaces.html#sec-linear-subspaces-35",
  "type": "Example",
  "number": "2.4.26",
  "title": "",
  "body": " Consider the linear subspace of defined as the set of solutions to the equation . The variables and are free variables. The set of solutions to this equation in can be given in parametric form by , where . It is easy to see that the vectors , and are linearly independent and that for any . This means that and form a basis of . Therefore, .  "
},
{
...
{
  "id": "sec-linear-subspaces-43",
  "level": "2",
  "url": "sec-linear-subspaces.html#sec-linear-subspaces-43",
  "type": "Proof",
  "number": "2.4.1",
  "title": "",
...
{
  "id": "sec-linear-subspaces-44",
  "level": "2",
  "url": "sec-linear-subspaces.html#sec-linear-subspaces-44",
  "type": "Example",
  "number": "2.4.30",
  "title": "",
...
},
{
  ...
  "number": "2.4.3",
  "title": "",
  "body": "  Find a basis for the linear subspace of defined by the solution set of each linear system below. Determine their dimensions.                         "
},
{
...
{
  "id": "exercises-chapter2-section4-5",
  "level": "2",
  "url": "sec-linear-subspaces.html#exercises-chapter2-section4-5",
  "type": "Exercise",
  "number": "2.4.5",
  "title": "",
...
},
{
  ...
  "number": "2.4.7",
  "title": "",
  "body": "  Let be a linear map.   Show that the subset of consisting of vectors such that is a linear subspace of .    Show that the subset of consisting of vectors for which there exists a vector such that is a linear subspace of .      "
},
{
...
{
  "id": "exercises-chapter2-section4-10",
  "level": "2",
  "url": "sec-linear-subspaces.html#exercises-chapter2-section4-10",
  "type": "Exercise",
  "number": "2.4.10",
  "title": "",
