...
},
{
  ...
  "number": "1.3.1",
  "title": "Gauss-Jordan elimination.",
  "body": " Gauss-Jordan elimination   A linear system with variables and equations is equivalent to a linear system with variables and equations in reduced echelon form. Moreover, a homogeneous linear system with $m$ variables and $n$ equations is equivalent to a homogeneous linear system with $m$ variables and $n$ equations.   "
},
{
  "id": "sec-gauss-18",
  "level": "2",
